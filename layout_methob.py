...
def complex_layout(main_layout: QGridLayout, paper_layout_widget: tuple[QWidget, QWidget],
    ...
    assert 2 <= altogether_sub_layout <= 6, "there must be between 2-6 sub layouts"
    ...
    if not widget_paper_middle:
        ...
        split_first, *split_middle, split_last = widget_paper_middle

    if not middle_sub_layout:
        del middle_sub_layout
    else:
        new_first, *new_middle, new_last = middle_sub_layout
